...
(function() {
    ...
    style.textContent = [
        ...
        '[data-theme="dark"] .chat-suggestion-btn{background:#2c2c2e;border-color:#38383a;color:#f5f5f7}',
        '[data-theme="dark"] .chat-suggestion-btn:hover{background:#3a3a3c;border-color:#3b82f6}',
        '[data-theme="dark"] .chat-new-btn:hover{background:#3a3a3c}',
        '[data-theme="dark"] .chat-close-btn:hover{background:#3a3a3c}',
        '[data-theme="dark"] .chat-msg-ai code{background:#2c2c2e}',
        '[data-theme="dark"] .chat-error{background:rgba(220,38,38,0.1);color:#f87171;border-color:rgba(220,38,38,0.3)}',
    ...
    bubble.innerHTML =
        ...
        '<span class="bubble-text">AI Chat</span>' +

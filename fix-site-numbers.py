#!/usr/bin/env python3
"""
DO NOT RUN to push 182 / 3,400+ coverage.

Canonical COL/salary coverage is 113 cities / 2,483 neighborhoods.
Retire coverage is ~230 cities and must be labelled as retire coverage.
This file previously spread the 182/3,400+ claims. Left in the repo so
history is honest; it is not a safe fixer anymore.
"""
import sys
print("Refusing to run: COL/salary coverage is 113 cities / 2,483 neighborhoods.")
sys.exit(1)

# Original script body archived below so it cannot be run accidentally.
